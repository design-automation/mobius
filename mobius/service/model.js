...
mobius.factory('generateCode', ['$rootScope',function ($rootScope) {
    ...
    return {
        ...
        //generateCode: function (subgraph){
        //    var model = {};
        //
        //    if(subgraph){
        //        model = subgraph;
        ...
        //                + model.chartViewModel.nodes[i].data.name + '\n';
        //
        //            model.outerCodeList[i] += 'function ' + data.chartViewModel.nodes[i].data.name +' (';
        //
        //            // function inputs
        //
        //            var num_input_ports = model.chartViewModel.nodes[i].inputConnectors.length;
        ...
        //
        //            if(model.chartViewModel.nodes[i].data.subGraph){
        //                console.log(model.chartViewModel.nodes[i].data.subGraphModel);
        //                this.generateCode(model.chartViewModel.nodes[i].data.subGraphModel);
        //            }
        //
        //            // return value
        //            if(num_output_ports){
