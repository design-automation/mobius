...
<div id="main">
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>/** VIDAMO Module - open for editing by the module developer */

	/**
	 * Prints to Mobius console
	 * @param {string} content - The message to be printed
	 */
	 ...
	 * @param {int} red - Value between 1-255 for red color
 	 * @param {int} green - Value between 1-255 for green color
 	 * @param {int} blue - Value between 1-255 for blue color
	 */	
	 ...
	 * @param {float} degrees - Degrees to be converted to radians
	 */	
	...
	/**
	 * Gets the absolute(positive) value of a given number
	 * @param {float} number - Number for which absolute value is required
	 */
	...
	/**
	 * Gets the value of the given number upto the given number of digits
	 * @param {float} number - Actual Number 
	 * @param {float} digits - Number of significant digits required
	 */
	 ...
	 * @param {array} matrix - Matrix 1
	 * @param {array} matrix - Matrix 2
	 */
	...
	/**
	 * Gets the cross product of two matrices
	 * @param {array} matrix - Matrix 1
	 * @param {array} matrix - Matrix 2
	 */
...
<nav>
    <h2><a href="index.html">Home</a></h2><h3>Global</h3><ul><li><a href="global.html#convertDegreesToRadians">convertDegreesToRadians</a></li><li><a href="global.html#convertRadiansToDegrees">convertRadiansToDegrees</a></li><li><a href="global.html#getAbsoluteValue">getAbsoluteValue</a></li><li><a href="global.html#getCrossProduct">getCrossProduct</a></li><li><a href="global.html#getDotProduct">getDotProduct</a></li><li><a href="global.html#getSignificantDigits">getSignificantDigits</a></li><li><a href="global.html#print">print</a></li><li><a href="global.html#rgbToHex">rgbToHex</a></li></ul>
</nav>

<br class="clear">

<footer>
    Documentation generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc 3.3.3</a> on Thu Nov 05 2015 09:28:50 GMT+0800 (Malay Peninsula Standard Time)
</footer>
