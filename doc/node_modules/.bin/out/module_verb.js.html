...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: module_verb.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: module_verb.js</h1>
 ...
 */
	 ...
	 * @memberof frm
	 */
	frm.byXYPoints = function(origin, xPoint, yPoint){
		...
		if( mtx.dot(xaxis, yaxis) != 0)
			msc.print("Axes are not perpendicular");
	 ...
	 * @memberof frm
	 */
	frm.byXZPoints = function(origin, xPoint, zPoint){		
	 ...
	 * @memberof frm
	 */
	frm.byYZPoints = function(origin, yPoint, zPoint){
	 ...
	 * @memberof frm
	 */
	frm.byXYAxes = function(origin, xAxis, yAxis){
	 ...
	 * @memberof frm
	 */
	frm.byXZAxes = function(origin, xAxis, zAxis){
	 ...
	 * @memberof frm
	 */
	frm.byYZAxes = function(origin, yAxis, zAxis){
	 ...
	 * @memberof sld
	 */
	sld.byExtrusion = function(surface, frame, xDistance, yDistance, zDistance){
	 ...
	 * @memberof sld
	 */
	sld.bySurfaces = function (listOfSurfaces){
		//checked
	 ...
	 * @memberof srf
	 */
	srf.nurbsByData = function ( frame, degreeU, degreeV, knotsU, knotsV, controlPoints, weights ){
	 ...
	 * @memberof srf
	 */
	srf.nurbsByCorners = function ( frame, cornerpoints ){
	 ...
	 * @memberof sld
	 */
	srf.nurbsByExtrusion  = function(frame, curve, xDistance, yDistance, zDistance){
	 ...
	 * @memberof srf
	 */
	srf.nurbsByLoft = function( listOfCurves, degree ){
	 ...
	 * @memberof srf
	 */
	srf.nurbsByRevolution = function(frame, sectionCurve, angle){
	 ...
	 * @memberof srf
	 */
	srf.nurbsBySweep = function( sectionCurve, railCurve ){
	 ...
	 * @memberof srf
	 */
	srf.nurbsSphere = function(frame, radius){
	 ...
	 * @memberof srf
	 */
	srf.nurbsCone = function(frame, height, radius1, radius2){
	 ...
	 * @memberof srf
	 */
	srf.nurbsPipe = function(centreCurve, radius){
...
/*		var sectionCurves  = [];
	 ...
	 * @memberof srf	 
	 */
	srf.uvGridByNumber = function(surface, uSegments, vSegments){
...
/*	srf.uvGridByDistance = function(surface, uDistance, vDistance){
	 ...
	 * @memberof srf
	 */
	srf.getPoints = function(surface, uvList){
	 ...
	 * @memberof srf
	 */
	srf.getFrames = function( surface, uvList ){
	 ...
	 * @memberof srf
	 */
	srf.getNormals = function( surface, uvList ){
	 ...
	 * @memberof srf
	 */
	srf.getTangents = function( surface, uvList ){
	 ...
	 * @memberof srf
	 */
	srf.getIsoCurves = function( surface, uOrvList, useV ){
	 ...
	 * @memberof srf
	 */
	srf.divide = function(surface, uvGrid){
...
/*	srf.carve = function(surface, uv1, uv2, hole){
	 ...
	 * @memberof crv
	 */
	crv.nurbsByData = function( frame, degree, knots, controlPoints, weights ){
	 ...
	 * @memberof crv
	 */
	crv.nurbsByPoints = function( frame, points, degree ){
	 ...
	 * @memberof crv
	 */
	crv.bezierByPoints = function(frame, points, weights) {
	 ...
	 * @memberof crv
	 */
	crv.arc = function(frame, radius, minAngle, maxAngle){
...
/*	crv.arcByPointsSOE = function(startPoint, onArcPoint, endPoint){

	};

	crv.arcByPointsCSE = function(centrePoint, startPoint, endPoint){
	 ...
	 * @memberof crv
	 */
	crv.circle = function(frame, radius){
	 ...
	 * @memberof crv
	 */
	crv.ellipse = function(frame, xRadius, yRadius) {
	 ...
	 * @memberof crv
	 */
	crv.ellipseArc = function(frame, xRadius, yRadius, minAngle, maxAngle){
	 ...
	 * @memberof crv
	 */
	crv.line = function(frame, startPoint, endPoint){
	 ...
	 * @memberof crv
	 */
	crv.divideByNumber = function(curve, numPoints){
	 ...
	 * @memberof crv
	 */
	crv.divideByDistance = function(curve, distance){
	 ...
	 * @memberof crv
	 */
	crv.getPoints = function(curve, tList){
	 ...
	 */
	 /*to be verified*/
	crv.getFrames = function(curve, tList, upVector){
	 ...
	 * @memberof crv
	 */
	crv.getTangents = function(curve, tList){
...
/*	crv.carve = function(curve, t1, t2, hole){
	 ...
	 */
	/*to be fixed*/
	crv.divideByTList = function(curve, tList){
	 ...
	 * @memberof crv
	 */
	crv.convertToPolyline = function(curve, tList){
	 ...
	 * @memberof pnt
	 */
	pnt.midPoint = function(point1, point2){
	 ...
	 * @memberof pnt
	 */
	pnt.distance = function(point1, point2){
	 ...
	 * @memberof vec
	 */
	vec.angle = function(vector1, vector2){
	 ...
	 * @memberof vec
	 */
	vec.add = function( vector1, vector2){
	 ...
	 * @memberof vec
	 */
	vec.subtract = function( vector1, vector2 ){
	 ...
	 * @memberof vec
	 */
	vec.resize = function(vector, length){
	 ...
	 * @memberof vec
	 */
	vec.scale = function(vector, factor){
	 ...
	 * @memberof obj
	 */
	obj.addMaterial = function(obj, material_type, wireframe, color_hex, transparent){
		var option = {	
			wireframe: wireframe,
			color: color_hex,
	...
	obj.addMaterial.prototype.return  = false;
	 ...
	 * @memberof obj
	 */
	obj.addData = function(obj, dataName, dataValue){
	...
	obj.addData.prototype.return = false;
	 ...
	 * @memberof trn
	 */
	trn.reflect = function(object, frame, copy){
	 ...
	 * @memberof trn
	 */
	trn.rotate = function(object, frame, angleX, angleY, angleZ, copy){
	 ...
	 * @memberof trn
	 */
	trn.scale = function(object, frame, scaleX, scaleY, scaleZ, copy) {
	 ...
	 * @memberof trn
	 */
	trn.shift = function(object, frame, shiftX, shiftY, shiftZ, copy){
	 ...
	 * @memberof trn
	 */
	trn.move = function(object, point, copy){
	 ...
	 * @memberof mtx
	 */
	mtx.dot = function( matrix1, matrix2 ){
	 ...
	 * @memberof mtx
	 */
	mtx.cross = function( matrix1, matrix2 ){
	 ...
	 * @memberof lst
	 */
	lst.append = function(list, itemOrList){
		list.push(itemOrList);
	};

	lst.append.prototype.return = false;
	 ...
	 * @memberof lst
	 */
	lst.insert = function(list, item, index){
		list.splice(index, 0, item);
	};


	lst.insert.prototype.return = false;
	 ...
	 * @memberof lst
	 */
	lst.extend = function(list, extension_list){
	...
	lst.extend.prototype.return = false;
	 ...
	 * @memberof lst
	 */
	lst.remove = function(list, index) {
		list.splice(index, 1);
	};

	lst.remove.prototype.return = false;
	 ...
	 * @memberof lst
	 */
	lst.sequence = function(start, end, stepSize){
	 ...
	 * @memberof lst
	 */
	lst.average = function(numericList){
	 ...
	 * @memberof lst
	 */
	lst.range = function( numericList ){
	 ...
	 * @memberof msc
	 */
/*	msc.rgbToHex = function(red, green, blue){
	 ...
	 * @memberof msc
	 */
	msc.sigDig = function(number, digits){
