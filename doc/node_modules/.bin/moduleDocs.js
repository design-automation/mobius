 ...
 */
	 ...
	 */
	nurbsByData = function ( frame, degreeU, degreeV, knotsU, knotsV, controlPoints, weights ){
	 ...
	 */
	 //checked
	nurbsByExtrusion  = function(curve, direction){
...
/*	carve = function(surface, uv1, uv2, hole){
	 ...
	 */
	nurbsByData = function( degree, knots, controlPoints, weights ){
	 ...
	 */
	nurbsByPoints = function( points, degree ){
	 ...
	 * @returns {curve object}  - NURBS Curve
	 */
	bezierByPoints = function(points, weights) {
